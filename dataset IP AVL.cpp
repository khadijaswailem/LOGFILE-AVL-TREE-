...
//        return false;
//    }
//    friend ostream& operator << (ostream& os, const myData& other) {//for the cout operator for the traverse method
//        os << other.ip;
//        return os;
//    }
//    ~myData() {};
...
//
//    cout<<"Traversing the AVL tree with IP:"<<endl;
...
//    //myData d;//creating an object for each row from the adt i created 
//    //d.setip("123.34.25.abc");//setting the values
//    //d.setdate("12/05/2023");
//    //d.settime("00:00:00");
//    //myData c;//creating an object for each row from the adt i created 
//    //c.setip("453.67.999.xyz");//setting the values
//    //c.setdate("30/11/1987");
//    //c.settime("12:00:00");
//    //string ret = d > c;
//    //cout << "RET: " << ret << endl;
//}
